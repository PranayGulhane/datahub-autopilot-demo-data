...
| **Detected** | 2026-08-02 14:38 UTC+0000 |
...
The 'order_total' column in the 'raw.orders' dataset has been renamed to 'order_amount'. This change will break any downstream consumers, such as dashboards, queries, or pipelines, that explicitly select this column by name, as they will now reference a non-existent column.

## Why this is critical

This schema change is critical due to its impact on 3 business-critical downstream assets (tier1) and a total of 8 affected assets. The highest criticality tier affected is tier1, which is the most critical. If left unmanaged, this change could lead to significant data inconsistencies and disruptions in revenue reporting and customer insights, ultimately affecting the organization's ability to make informed business decisions.
...
A critical schema migration is required for the raw.orders dataset to address a breaking change. If not addressed, this will impact 6 downstream assets, including key business intelligence dashboards, and may lead to inaccurate customer lifetime value and revenue reporting. The first step is to notify the owners of the affected assets.
